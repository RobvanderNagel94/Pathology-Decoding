...
def find_peaks_alpha_power(x_o1_closed, x_o2_closed, threshold=1.):
    ...
    threshold : float
         Parameter to find neighbouring peak frequencies (e.g., pk +- threshold)
    ...
    f_lim = f[(f >= fmin) & (f <= fmax)]            # [fmin,fmax] = [3,18] Hz
